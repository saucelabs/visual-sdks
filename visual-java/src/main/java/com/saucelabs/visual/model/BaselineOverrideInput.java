...
/**
 * Helper class for serializing optional values (undefined (omitted), null, and Value) into GraphQL
 * schema. Internal use only. Extends the default BaselineOverrideIn so we can use it in standard
 * graphql requests / inputs as a subclass while handling serialization differently.
 */
...
public class BaselineOverrideInput extends BaselineOverrideIn {
  ...
  @GraphQLScalar(
      fieldName = "browser",
      graphQLTypeSimpleName = "Browser",
      javaClass = Browser.class,
      listDepth = 0)
  ...
  @GraphQLScalar(
      ...
      graphQLTypeSimpleName = "OperatingSystem",
      javaClass = OperatingSystem.class,
      listDepth = 0)
