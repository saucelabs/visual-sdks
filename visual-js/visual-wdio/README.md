...
It will extend WebdriverIO's `browser` object with two new commands:
...
> **Warning:**
> `browser.check()` and `browser.checkResult()` have been deprecated and will be removed in a future version.
