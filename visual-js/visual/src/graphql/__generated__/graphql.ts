...
export type CreateSnapshotUploadFromWebDriverIn = {
  /** @deprecated Use `buildUuid`. This field will be removed in a future update. */
  buildId?: InputMaybe<Scalars['ID']>;
  buildUuid?: InputMaybe<Scalars['UUID']>;
  sessionId: Scalars['ID'];
...
export type Mutation = {
  ...
  /** @deprecated Use createSnapshotFromWebDriver. This will be removed by 2024-02-11. */
  createSnapshotUploadFromWebDriver: SnapshotUpload;
  finishBuild: Build;
  updateDiff: Diff;
};
